    ...
    <div className="overflow-auto">
      <table className="table-md place-self-center">
        ...
        <tbody>
          {/* row 1 */}
          <tr>
            <th>Total Distributor-Retailer Usage Charge</th>
            <td>${data.totalRetailerCost.toFixed(2)}</td>
          </tr>
          {/* row 2 */}
          <tr>
            <th>Total State Bulk Water Charge</th>
            <td>${data.totalStateBulkWaterCost.toFixed(2)}</td>
          </tr>
          {/* row 3 */}
          <tr>
